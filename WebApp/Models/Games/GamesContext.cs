...
public partial class GamesContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            // Прибираємо HasNoKey(), додаємо HasKey з двома стовпцями
            entity.HasKey(e => new { e.GamePlatformId, e.RegionId });
            ...
            entity.HasOne(d => d.GamePlatform)
                // якщо в GamePlatform є колекція RegionSales
                .WithMany(gpl => gpl.RegionSales)
                .HasForeignKey(d => d.GamePlatformId);

            entity.HasOne(d => d.Region)
                .WithMany() // Якщо в Region не потрібна колекція RegionSales
